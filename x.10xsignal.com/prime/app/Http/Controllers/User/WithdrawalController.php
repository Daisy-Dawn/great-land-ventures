...
class WithdrawalController extends Controller
{
    ...
    public function completewithdrawal(Request $request){
        ...
        $objDemo = new \stdClass();
        $objDemo->message = "This is to inform you that you a user have made a withdrawal request of $settings->currency$amount, kindly login to your account to review and take neccesary action.";
        $objDemo->sender = $settings->site_name;
        $objDemo->date = \Carbon\Carbon::Now();
        ...
        $objDemouser->message = "Your withdrawal request of $settings->currency$amount was successful, kindly wait while we process your request";

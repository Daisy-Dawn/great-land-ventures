						...
						<div class="col-lg-4">
							<div class="pricing-table card purple border bg-{{$bg}} shadow p-4">
								...
								<div class="price-tag">
									...
									<span class="amount text-{{$text}}">{{$plan->increment_amount}} %      </span>	<span class="symbol text-{{$text}}">   {{$plan->increment_interval}}</span>
								</div>
								<!-- Features -->
								<div class="pricing-features">
									...
									<div class="feature text-{{$text}}">Top up Interval:<span class="text-{{$text}}">{{$plan->increment_interval}}</span></div>
									<div class="feature text-{{$text}}">Total Duration for Investment:<span class="text-{{$text}}">{{$plan->expiration}}</span></div>
								</div> <br>
								<!-- Button -->
								<div class="">

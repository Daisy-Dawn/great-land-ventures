    ...
    <section class="container-fluid bg-market">
        <div class="row">
          <div class="col-6 abt-us-txt">
            <h2 class="p-20 white">  Commodities  </h2>
          </div>
    ...
    <div class="row">
      <div class="col-md-8 col-sm-12 col-crypto">
        <div class="container">
          ...
          <img src="{{$settings->site_address}}/public/images/item-indices.png" >
      ...
      <div class="col-md-4 col-sm-12">
        ...
        <div class="container">
          <div class="crypto-cat">
            ...
            <div class="current-crypto">  <p> <i class="fas fa-arrow-alt-circle-right"></i> &nbsp Commodities</p></div>

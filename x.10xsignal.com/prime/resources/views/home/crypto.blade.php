   ...
   <div class="row">
     <div class="col-md-8 col-sm-12 col-crypto">
       <div class="container">
         ...
         <img src="{{$settings->site_address}}/public/images/crypto.jpg" style="padding: 20px;">
         <div style="padding: 20px;">
           <h3> What is a Cryptocurrency?</h3>
           <p class="t-p">Cryptocurrencies (Crypto) are virtual currencies that typically use a decentralised network to carry out secure financial transactions. With {{$settings->site_name}} trading platform you can trade Crypto – such as Bitcoin, Ripple XRP, Ethereum and more.</p>
           <br />
           <h3>Why Trade Cryptocurrencies with {{$settings->site_name}}</h3>
           ...
           <p>Discover all the advantages of trading cryptocurrencies with {{$settings->site_name}} </p>
           <br />
     ...
     <div class="col-md-4 col-sm-12">
       ...
       <div class="container">
         <div class="crypto-cat">
           <div class="current-crypto">  <p> <i class="fas fa-arrow-alt-circle-right"></i> &nbsp Cryptocurrencies</p></div>

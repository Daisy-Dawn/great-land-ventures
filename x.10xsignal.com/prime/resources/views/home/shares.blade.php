      ...
      <div class="row">
        <div class="col-md-8 col-sm-12 col-crypto">
          <div class="container">
            ...
            <img src="{{$settings->site_address}}/public/images/item-shares.png" >
            <div style="padding: 20px;">
              ...
              <br />
              <h3> <b> Trade Cannabis Index and Share CFDs at  {{$settings->site_name}} </b></h3>
              ...
              <p>Discover all the advantages of trading shares with  {{$settings->site_name}}:</p>
              <br />
        ...
        <div class="col-md-4 col-sm-12">
          ...
          <div class="container">
            <div class="crypto-cat">
              ...
              <div class="current-crypto.php">  <p> <i class="fas fa-arrow-alt-circle-right"></i> &nbsp Shares</p></div>

            ...
            <div class="pb-3 row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    ...
                    <div class=" shadow  login-page roundedd border-1 ">
                        <div class="card-body">
                            <h4 class="text-center card-title" style="color:#fff !important">Password Reset</h4>
                            <form method="POST" action="{{ route('password.email') }}"  class="mt-4 login-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-3 mb-0"><small class="mr-2 text-dark" style="color:#fff !important">Repeat Login
                                                ?</small> <a href="{{route('login')}}"
                                                class="text-dark font-weight-bold" style="color:#fff !important">Login</a></p>
                                    </div>
                                    <!--end col-->

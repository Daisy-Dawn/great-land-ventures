                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    <a href="/"><img src="{{ asset('storage/app/public/photos/'.$settings->logo)}}" alt="" class="mb-3 img-fluid auth__logo"></a>
                     ...
                     <div class=" shadow  login-page roundedd border-1 ">
                        <div class="card-body">
                            <h4 class="text-center card-title" style="color:#fff">Create an Account</h4>
                             <p class="text-{{$text}}" style="color:#fff">{{ date('l jS \of F Y h:i:s A') }}</p>
                            <form method="POST" action="{{ route('register') }}"  class="mt-4 login-form">
                                 @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label  style="color:#fff !important">UserName <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#fff !important">FullName <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#fff !important">Your Email <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#fff !important">Phone Number <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#fff !important">Password <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#fff !important">Confirm Password <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="key" class="fea icon-sm icons"></i>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label style="color:#fff !important">Country <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color:#fff !important">Referral ID <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="user" class="fea icon-sm icons"></i>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="customCheck1">I Accept the <a
                                                            href="{{route('privacy')}}" class="text-primary"style="color:#fff !important">Terms And Privacy Policy</a></label>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="mb-0 col-lg-12">
                                        <button class="btn btn-primary btn-block pad" style="background-color:#0b4f80 !important"type="submit">Register</button>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-3 mb-0"><small class="mr-2 text-white">Already have an account

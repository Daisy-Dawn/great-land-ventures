            ...
            <div class="pb-3 row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    ...
                    <div class=" shadow  login-page roundedd border-1 ">
                        <div class="card-body">
                            <h4 class="text-center card-title" style="color:#fff !important">User Login</h4>
                            ...
                            <form method="POST" action="{{ route('login') }}"  class="mt-4 login-form">
                                ...
                                <div class="row">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label style="color:#fff !important" class="custom-control-label" for="customCheck1">Remember
                                                        me</label>
                                                </div>
                                            </div>
                                            <p class="mb-0 forgot-pass"><a href="{{ route('password.request') }}"
                                                    class="text-dark font-weight-bold" style="color:#fff !important">Forgot password ?</a></p>
                                        </div>
                                    </div>
                                    <!--end col-->

                                    <div class="mb-0 col-lg-12">
                                        <button class="btn btn-primary btn-block pad" style="background-color:#0b4f80 !important" type="submit">Sign in</button>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-3 mb-0"><small class="mr-2 text-dark" style="color:#fff !important">Don't have an account
                                                ?</small> <a href="{{ route('register') }}"
                                                class="text-dark font-weight-bold" style="color:#fff !important">Sign Up</a></p>
                                    </div>
                                    <!--end col-->

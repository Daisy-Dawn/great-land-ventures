...
class DepositController extends Controller
{
    ...
    public function savestripepayment(Request $request)
    {
        ...
        $objDemo->message = "This is to inform you that you have successfully deposited $user->currency$request->amount.";
    ...
    public function savedeposit(Request $request){
        ...
        //send email notification
        $objDemo = new \stdClass();
        $objDemo->message = "This is to inform you of a successfull Deposit of $user->currency $request->amount, that just occured on your system. please login to process this deposit";
        $objDemo->sender = $settings->site_name;
        $objDemo->date = \Carbon\Carbon::Now();
        $objDemo->subject ="Successful Deposit";
        ...
        $objDemou->message = "This is to inform you of a successfull deposit of $user->currency $request->amount, that just occured on your account. please wait while we process this transaction, you will receive a notification of your transaction status.";

                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    ...
                    <div class=" shadow card login-page roundedd border-1 ">
                       ...
                       <a href="/"><img src="{{ asset('storage/app/public/photos/'.$settings->logo)}}" alt="" class="mb-3 img-fluid auth__logo"></a> 
                            ...
                            <h4 class="text-center card-title" style="color: !important">User Login</h4>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color: !important">Your Email <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label style="color: !important">Password <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label style="color:#228f26 !important" class="custom-control-label" for="customCheck1">Remember
                                                        me</label>
                                                </div>
                                            </div>
                                            <p class="mb-0 forgot-pass"><a href="{{ route('password.request') }}"
                                                    class="text-dark font-weight-bold" style="color: !important">Forgot password ?</a></p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-3 mb-0"><small class="mr-2 text-dark" style="color:#05803a !important">Don't have an account
                                                ?</small> <a href="{{ route('register') }}"
                                                class="text-dark font-weight-bold" style="color: !important">Sign Up</a></p>
                                    </div>
                                    <!--end col-->
                                    
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0"><small class="mr-2 text-dark" style="color: !important">&copy; Copyright  {{date('Y')}} &nbsp; {{$settings->site_name}} &nbsp; All Rights Reserved.</small>
                                        </p>
                                    </div>
                                </div>
                                <!--end row-->

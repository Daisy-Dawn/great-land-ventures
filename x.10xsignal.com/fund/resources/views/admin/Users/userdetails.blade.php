                        ...
                        <div class="card-body">
                            ...
                            <div class="p-3 mt-4 border rounded row text-{{$text}}">
                                <div class="col-md-3">
                                    ...
                                    <p>{{Auth::user()->currency}}{{number_format($user->account_bal)}}</p>
                                </div>
                                <div class="col-md-3">
                                    <h5>Profit</h5>
                                    <p>{{Auth::user()->currency}}{{number_format($user->roi)}} </p>
                                </div>
                                <div class="col-md-3">
                                    <h5>Referral Bonus</h5>
                                    <p>{{Auth::user()->currency}}{{number_format($user->ref_bonus)}}</p>
                                </div>
                                <div class="col-md-3">
                                    <h5>Bonus</h5>
                                    <p>{{Auth::user()->currency}}{{number_format($user->bonus)}}</p>
                                </div>
                                <div class="col-md-3">

							...
							<div class="card bg-{{$bg}} shadow-lg p-2 p-md-4">
								...
								<div class="card-body">
									@if($title !="Complete Payment")
										...
										@endphp
										<div>
											<h4 class="text-{{$text}}">You are to make payment of <strong>{{Auth::user()->currency}}{{number_format($amount)}}</strong> using your selected payment method. Screenshot and upload the proof of payment</h4>
											<h4>
											...
											@if ($payment_mode->methodtype != 'currency')
												...
												<div class="form-group">
    												<div class="mb-3 input-group">
    													<input type="text" class="form-control myInput readonly text-{{$text}} bg-{{$bg}}" value="13bRcDEpSaoTe5qUb2ANmNKsu74SF7GrQv" id="myInput" readonly>
